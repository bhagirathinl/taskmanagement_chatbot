...
import { sendToChatbot, createSession, closeSession, type TRTCCredentials } from '../services/api';
...
export default function AvatarStream({ initialCredentials, initialSessionId, onError }: AvatarStreamProps) {
  ...
  const connectToTRTC = useCallback(async (creds: TRTCCredentials) => {
    ...
    try {
      ...
      client.on(TRTC.EVENT.REMOTE_AUDIO_AVAILABLE, async ({ userId }) => {
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.instructions}>
        <p><strong>Chatbot Mode:</strong> The avatar responds using your chatbot.</p>
        <ol>
          <li>Click "Enable Mic" to start your microphone</li>
          <li>Speak clearly into your microphone</li>
          <li>Your speech is sent to the chatbot</li>
          <li>The avatar speaks the chatbot's response</li>
        </ol>
      </div>
